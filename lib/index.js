  ...
  buildChrome(config) {
    ...
    if (config.proxyConfig) {
      ...
      return new ProxyPlugin({ proxyConfig: config.proxyConfig, chromeOptions: chromeOptions })
        .then((plugin) => {
          debug('buildChrome(): chromeOptions are ready')
          ...
          this.driver = new webdriver.Builder()
            ...
            .build()
          ;
          debug('buildChrome(): driver has been built WITH proxyPlugin')
          return this.driver;
        })
    } else {
      ...
      this.driver = new webdriver.Builder()
        ...
        .build()
      debug('buildChrome(): driver has been built WITHOUT proxyPlugin')
      return this.driver;
    }
