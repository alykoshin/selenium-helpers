...
const debug = require('debug')('selenium-utils');
...
//
  ...
  scrollIntoView(webElementOrCssString) {
    ...
    if (typeof webElementOrCssString === 'string')
      return this.driver
        ...
        .then((el) => this._scrollIntoView(el));
    else
      return this._scrollIntoView(webElementOrCssString);
  };
  ...
  elementClick(webElementOrCssString) {
    ...
    if (typeof webElementOrCssString === 'string')
      return this.driver
        .findElement(By.css(webElementOrCssString))
        .then((el) => this._elementClick(el));
    else
      return this._elementClick(webElementOrCssString);
  };
  ...
  elementType(webElementOrCssString, value) {
    ...
    if (typeof webElementOrCssString === 'string')
      return this.driver
        .findElement(By.css(webElementOrCssString))
        .then((el) => this._elementType(el, value));
    else
      return this._elementType(webElementOrCssString, value);
  };
